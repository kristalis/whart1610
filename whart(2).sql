...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 27, 2017 at 06:04 PM
...
INSERT INTO `pages` (`id`, `bannertext`, `bannertext1`, `headertext`, `banner`, `created_at`, `updated_at`) VALUES
(1, 'Welcome to', 'The White Hart', 'The White Hart offers contemporary food, real ales, an extensive gin range,\r\ncocktails & an exciting wine list.', 'white-hart-gen-gallery-img-11.jpg', NULL, '2017-09-26 09:02:11'),
(2, 'About', 'The White Hart', 'Owned & run by brothers James & Tom Bainbridge, The White Hart offers varied menus, real ales, an extensive gin range, cocktails & an exciting wine list. The restaurant, hotel & function space in Welwyn serves breakfast, lunch and dinner seven days a week. \r\n\r\nThe White Hart dates back to 1681 and it was Welwyn’s main coaching inn. It was a popular overnight stop for travellers going north from London and at one point it offered fourteen beds for humans and stabling for thirty four horses. It was also home to the village courtroom, where petty sessions were held, when misdemeanours may have included theft and assault and, ironically, drunkenness.', 'white-hart-parallax-banner-9.jpg', '2017-09-15 14:52:01', '2017-09-26 09:45:59'),
(3, 'Our', 'ACCOMMODATION', 'We have 13 bedrooms available at The White Hart. All rooms have an en suite bathrooms. Rates below include breakfast and are based on double occupancy.', 'white-hart-parallax-banner-5.jpg', NULL, '2017-09-25 11:12:55'),
(4, 'Food & Drink', 'MENU', NULL, 'white-hart-gen-gallery-img-8.jpg', NULL, '2017-09-27 08:14:34'),
(5, 'Latest news &', 'Events & Offers', 'evens', 'white-hart-gallery-preview-img-9.jpg', NULL, '2017-09-26 10:05:11'),
(6, 'Gallery', 'Gallery', 'gallery', 'white-hart-parallax-banner-5.jpg', NULL, '2017-09-26 12:47:01'),
(7, 'Opening times &', 'Contact US', 'The Tilbury\r\n\r\n\r\n\r\nEmail: \r\nTelephone:', 'white-hart-offers-img-2.jpg', NULL, '2017-09-26 13:14:58'),
(8, 'Our', 'FUNCTION ROOM', 'Our function room is the former court house of Welwyn but now we use it for wedding receptions, parties, celebrations and conferences.', 'white-hart-gallery-preview-img-11.jpg', NULL, '2017-09-26 15:02:47');
