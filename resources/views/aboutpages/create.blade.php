...
<!-- form start -->
             <!-- form start -->
              <form class="form-horizontal" method="POST" action="{{ url('abouts/update/2') }}" id="frmAbout" enctype="multipart/form-data">
                        {{ csrf_field() }}
    <!-- Main content -->
      ...
      @foreach($aboutcontents as $aboutcontent)  
          ...
          <div class="box box-primary">
            ...
            <div class="col-md-7">
                <div class="form-group{{ $errors->has('chefname') ? ' has-error' : '' }}">
                      ...
                      <input type="text" id="chefname" name="chefname" class="form-control" value="{{$aboutcontent->chefname}}" data-toggle="tooltip" data-placement="bottom" title="Name of your Chef" disabled>
                  ...
                  <textarea class="form-control" rows="8"  id="chefdesc" name="chefdesc"  data-toggle="tooltip" data-placement="bottom" title="Chef's Information" disabled>{{$aboutcontent->chefdesc}}</textarea>
       ...
       <div class="col-md-4">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <div>
             <h3 class="box-title text-bold ">Chef list</h3> -    
            </div> <br>
            zvsv
           </div>
         </div>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title text-bold">Here you can add your Chef(s) details</h4>
              </div>
...
<div class="form-group{{ $errors->has('chefimages') ? ' has-error' : '' }}">
      ...
      <input type="file" name="chefimages" id="chefimages" class="btn btn-primary" placeholder="Please choose your image">
                ...
                <div class="form-group{{ $errors->has('chefname') ? ' has-error' : '' }}">
                    ...
                    <div class="form-group{{ $errors->has('chefdesc') ? ' has-error' : '' }}">
                  <label>History on Chef(s)</label>
                  <textarea class="form-control" rows="8"  id="chefdesc" name="chefdesc"  data-toggle="tooltip" data-placement="bottom" title="Enter Information about your Chefs' here"></textarea>
                      @if ($errors->has('chefdesc'))
                          <span class="help-block">
                              <strong>{{ $errors->first('chefdesc') }}</strong>
                          </span>
        ...
        <div class="form-group">
                <button type="submit" class="btn btn-primary pull-right"  form="frmMod"> Add Chef Details</button>
