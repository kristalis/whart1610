  ...
  <div class="col-md-12 text-center">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
             <div class='col-xs-6'>  <h3 class="box-title text-bold">Here you can add your menus </h3></div>
              <div class='col-xs-3'> <button fldnum="3" class="btn btn-success add_button" type="button">
                Add Text Menu Details
              </button></div><div class='col-xs-3'><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-info">
                Add Block Menu Details
              </button></div>
            </div>
            <!-- /.box-header -->
...
var i=0;
    ...
    var insHTML = '<div class="input-group"><input class="form-control text-bold" type="text" name="fld_val'+kakoi+'[]"><span class="input-group-btn"><button class="btn btn-danger remove_button" type="button"><span class="glyphicon glyphicon-minus"></span></button></span></div>';
